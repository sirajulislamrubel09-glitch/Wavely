    ...
    <div style={{
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .glow-cyan { box-shadow: 0 0 40px #00f5d444, 0 0 80px #00f5d422; }
        ...
        .float-delay { animation: float 4s 1s ease-in-out infinite; }
      ...
      <div style={{ position: "fixed", inset: 0, pointerEvents: "none", zIndex: 0, overflow: "hidden" }}>
        ...
        <div className="orb-2" style={{
          ...
          background: "radial-gradient(circle, #00f5d433 0%, transparent 70%)",
        }} />
        <div className="orb" style={{
      ...
      <nav className="nav-blur" style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ fontFamily: "'Sora'", fontWeight: 800, fontSize: 20, letterSpacing: -0.5 }}>
            Wavely
        ...
        <div style={{ display: "flex", gap: 10 }}>
          <button className="btn-ghost" style={{ padding: "8px 18px", borderRadius: 99, fontSize: 13, fontWeight: 600 }}>
            Log in
          </button>
      ...
      <section ref={heroRef} style={{
        ...
        <p className="hero-animate-3" style={{
          ...
          Join live music spaces, vibe with real people, discover your next obsession.
          Stream together. Chat. Feel every beat.
        </p>
        ...
        <div className="hero-animate-4" style={{ display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "center" }}>
          ...
          <button className="btn-ghost" style={{
            padding: "14px 32px", borderRadius: 99, fontSize: 15, fontWeight: 600,
          }}>
            Explore Spaces
          </button>
        </div>
        ...
        <div className="float glow-purple" style={{
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
            <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: 2, color: "#7c3aed", textTransform: "uppercase" }}>
              Now Playing
            </span>
            <div style={{ display: "flex", gap: 6 }}>
              {["🔥", "💜", "✨"].map((e, i) => (
                <span key={i} style={{ fontSize: 14, cursor: "pointer" }}>{e}</span>
              ))}
            </div>
          </div>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
              ...
              <span style={{ color: "#00f5d4", fontSize: 11, fontWeight: 700 }}>
          ...
          {/* Progress */}
          <div style={{
            height: 3, background: "#ffffff11", borderRadius: 2, marginBottom: 20, cursor: "pointer",
          }}>
          ...
          <div style={{
              ...
              <div style={{ display: "flex" }}>
                {["#7c3aed", "#00f5d4", "#a855f7"].map((c, i) => (
                  <div key={i} style={{
                    ...
                    background: c, border: "2px solid #12121e",
                    marginLeft: i > 0 ? -6 : 0,
            ...
            <button style={{
              ...
              color: "#a78bfa", borderRadius: 99, padding: "4px 12px",
      ...
      <section style={{ position: "relative", zIndex: 1, padding: "80px 24px", maxWidth: 900, margin: "0 auto" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 32 }}>
          <div>
            <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: 3, color: "#7c3aed", textTransform: "uppercase", marginBottom: 8 }}>
              Live Right Now
            </div>
          ...
          <span style={{ color: "#7c3aed", fontSize: 13, cursor: "pointer", fontWeight: 600 }}>View all →</span>
        </div>
          ...
          {spaces.map((space, i) => (
            <div key={i} className="space-card" style={{
              ...
              <div style={{ textAlign: "right" }}>
                <div style={{ color: "#00f5d4", fontWeight: 700, fontSize: 15 }}>
      ...
      <section style={{ position: "relative", zIndex: 1, padding: "60px 24px", maxWidth: 900, margin: "0 auto" }}>
        <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: 3, color: "#00f5d4", textTransform: "uppercase", marginBottom: 12 }}>
          Browse by Mood
        </div>
        <h2 style={{ fontSize: "clamp(24px, 4vw, 36px)", fontWeight: 800, letterSpacing: -1, marginBottom: 28 }}>
          Find your vibe
        </h2>
        <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
          {genres.map((g, i) => (
            <div key={g} className="genre-pill" style={{
              background: "#12121e",
      ...
      <section style={{ position: "relative", zIndex: 1, padding: "80px 24px", maxWidth: 900, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: 3, color: "#7c3aed", textTransform: "uppercase", marginBottom: 12 }}>
            Why Wavely
          </div>
          <h2 style={{ fontSize: "clamp(28px, 5vw, 44px)", fontWeight: 800, letterSpacing: -1 }}>
        ...
        <div className="feature-grid" style={{
          ...
          {[
            ...
            { icon: "🔍", title: "Discover Daily", desc: "AI-powered recommendations based on your mood, genre, and listening history.", color: "#a855f7" },
      ...
      <section style={{
        ...
        <div style={{
          background: "linear-gradient(135deg, #12121e, #1a0a2e)",
          border: "1px solid #7c3aed33",
          borderRadius: 32,
          padding: "60px 40px",
          position: "relative", overflow: "hidden",
          ...
          <div style={{ color: "#4040a0", fontSize: 12, marginTop: 16 }}>
            No credit card needed · Free forever · Cancel anytime
          </div>
        </div>
      </section>
